...
public class ConnectionIT extends BaseJDBCTest {
  ...
  public void testLoginTimeoutViaDataSource() throws SQLException {
    ...
    ds.setUrl("jdbc:snowflake://***REMOVED***");
    ds.setUser("fakeUser");
  ...
  public void testProdConnectivity() throws SQLException {
    String[] deploymentUrls = {
      "jdbc:snowflake://***REMOVED***",
      "jdbc:snowflake://sfcsupportva.us-east-***REMOVED***",
      "jdbc:snowflake://sfcsupporteu.eu-central-***REMOVED***"
    };
  ...
  public void testInsecureMode() throws SQLException {
    String deploymentUrl = "jdbc:snowflake://***REMOVED***";
    ...
    deploymentUrl = "jdbc:snowflake://***REMOVED***?insecureMode=true";
  ...
  public void testOrgAccountUrl() throws SQLException {
    ...
    Connection con =
        DriverManager.getConnection(
            "jdbc:snowflake://amoghorgurl-keypairauth_test_***REMOVED***",
            props);
